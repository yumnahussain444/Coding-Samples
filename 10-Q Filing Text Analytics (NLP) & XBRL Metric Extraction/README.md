...
2. Install dependencies (included at the top of the notebook).
3. Mount Google Drive.
4. Confirm the paths to the identifier list and the master index file.
5. Run the notebook top-to-bottom.

The final output file is written to:
- `/content/drive/MyDrive/edgar_q2_2020_10q_metrics.csv`
...
- Beautiful Soup and lxml libraries for parsing markup and structured documents
- Natural Language Toolkit sentence tokenizer resources for sentence segmentation
...
- The public filing archive may rate-limit automated requests; the notebook includes retry logic and pauses between downloads.
- Structured data file selection is heuristic and may fail for unusual filing layouts.
- Sentence counts are approximate because they depend on markup-to-text conversion quality and sentence segmentation behavior.
